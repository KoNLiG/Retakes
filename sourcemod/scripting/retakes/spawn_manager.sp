...
void Event_PlayerSpawn(Event event, const char[] name, bool dontBroadcast)
{
	...
	// Will be removed once the player manager is done.
	g_Players[client].spawn_role = SpawnRole_Attacker;
	...
	// Hardcoded A site origin for de_dust2.
	// will be removed once the gameplay system is done.
	float dest[3] = { 1141.333008, 2503.173096, 95.126724 };
